...
public final class PlaceJSONImpl extends TwitterResponseImpl implements Place, java.io.Serializable {
	...
	private PlaceJSONImpl[] containedWithIn;

	public PlaceJSONImpl(HttpResponse res, Configuration conf) throws TwitterException {
		super(res);
	...
	private void init(JSONObject json) throws TwitterException {
		try {
			...
			if (!json.isNull("contained_within")) {
				...
				containedWithIn = new PlaceJSONImpl[containedWithInJSON.length()];
	...
	public void setContainedWithIn(PlaceJSONImpl[] containedWithIn) {
